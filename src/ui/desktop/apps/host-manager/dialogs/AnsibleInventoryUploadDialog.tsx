    ...
    >
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload your local Ansible <code>hosts</code> (INI format) inventory
            file and any referenced private key files. Each Ansible group
            becomes a folder; YAML inventories are not supported.
          </DialogDescription>
        </DialogHeader>
        ...
        {identityFiles.length > 0 && step !== "config" && (
          <>
            ...
            <p className="text-xs text-muted-foreground mb-2">
              ...
              <code>ansible_ssh_private_key_file</code>. Skip any you don't have
              — those hosts will be imported without key auth and you can add
              keys later.
            </p>
