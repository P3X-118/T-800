...
T-800는 오픈 소스이며 영구 무료인 셀프 호스팅 올인원 서버 관리 플랫폼입니다. 단일 직관적인 인터페이스를 통해 서버와 인프라를 관리할 수 있는 멀티 플랫폼 솔루션을 제공합니다. T-800는 SSH 터미널 접속, SSH 터널링 기능, 원격 파일 관리 및 기타 다양한 도구를 제공합니다. T-800는 모든 플랫폼에서 사용 가능한 Termius의 완벽한 무료 셀프 호스팅 대안입니다.
...
- **데이터베이스 암호화** - 백엔드가 암호화된 SQLite 데이터베이스 파일로 저장됨. 자세한 내용은 [문서](https://t-800.i.sgc.ai/security)를 참조하세요
...
- **다국어 지원** - 약 30개 언어 내장 지원([Crowdin](https://t-800.i.sgc.ai/translations)으로 관리)
...
모든 계획된 기능은 [Projects](https://github.com/orgs/P3X-118/projects/2)를 참조하세요. 기여를 원하시면 [Contributing](https://github.com/P3X-118/T-800/blob/main/CONTRIBUTING.md)을 참조하세요.
...
모든 플랫폼에 T-800를 설치하는 방법에 대한 자세한 내용은 T-800 [문서](https://t-800.i.sgc.ai/install)를 방문하세요. 다음은 Docker Compose 파일 예시입니다:
...
T-800에 대한 도움이 필요하거나 기능을 요청하려면 [Issues](https://github.com/P3X-118/T-800/issues) 페이지를 방문하여 로그인하고 `New Issue`를 누르세요. 이슈는 가능한 한 상세하게 작성하고, 영어로 작성하는 것이 좋습니다. [Discord](https://discord.gg/jVQGdvHDrf) 서버에 참여하여 지원 채널을 이용할 수도 있지만, 응답 시간이 더 길 수 있습니다.
