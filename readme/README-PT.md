...
T-800 é uma plataforma de gerenciamento de servidores tudo-em-um, de código aberto, sempre gratuita e auto-hospedada. Ela fornece uma solução multiplataforma para gerenciar seus servidores e infraestrutura através de uma interface única e intuitiva. T-800 oferece acesso a terminal SSH, capacidades de tunelamento SSH, gerenciamento remoto de arquivos e muitas outras ferramentas. T-800 é a alternativa perfeita, gratuita e auto-hospedada ao Termius, disponível para todas as plataformas.
...
- **Criptografia de Banco de Dados** - Backend armazenado como arquivos de banco de dados SQLite criptografados. Consulte a [documentação](https://t-800.i.sgc.ai/security) para mais informações.
...
- **Idiomas** - Suporte integrado para ~30 idiomas (gerenciado pelo [Crowdin](https://t-800.i.sgc.ai/translations))
...
Consulte [Projetos](https://github.com/orgs/P3X-118/projects/2) para todas as funcionalidades planejadas. Se você deseja contribuir, consulte [Contribuir](https://github.com/P3X-118/T-800/blob/main/CONTRIBUTING.md).
...
Visite a [documentação](https://t-800.i.sgc.ai/install) do T-800 para mais informações sobre como instalar o T-800 em todas as plataformas. Caso contrário, veja um arquivo Docker Compose de exemplo aqui:
...
Se você precisa de ajuda ou deseja solicitar uma funcionalidade para o T-800, visite a página de [Issues](https://github.com/P3X-118/T-800/issues), faça login e clique em `New Issue`.
